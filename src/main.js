...
const MPContractAddress = "0xF2cE390B8d1Ec5bAc1d9eF9E766585B426695Ec4"
...
function productTemplate(_product) {
  return `
  <div class="card mb-4" style="border-radius: 30px; font-family: 'Monospace';">
  <img class="card-img-top" src="${_product.image}" alt="..." style="border-top-left-radius: 30px; border-top-right-radius: 30px;">
  <div class="position-absolute top-0 end-0 bg-warning mt-4 px-2 py-1 rounded-start">
    ${_product.sold} Sold
    </div>
    <div class="card-body text-left p-4 position-relative" style="font-size: 20px;">
      <div class="translate-middle-y position-absolute top-0">
        ${identiconTemplate(_product.owner)}
      </div>
      <h2 class="card-title fs-3 fw-bolder mt-2">${_product.name}</h2>
    ...
    <div class="d-grid gap-2">
      <a class="btn btn-lg btn-outline-dark buyBtn fs-6 p-3" style="font-family: 'Monospace'; border-radius: 30px; font-size: 20px" id=${_product.index}>
